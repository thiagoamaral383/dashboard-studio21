...
def create_views():
    ...
    try:
        ...
        print("  - dim_profissionais")
        print("  - dim_clientes")
        print("  - dim_servicos")
        print("  - dim_calendario")
        print("  - dim_categorias (física)")
        print("  - fct_vendas")
        print("  - fct_ocupacao")
        print("  - fct_taxas_cartao")
        print("  - int_financeiro_competencia")
        print("  - int_financeiro_caixa")
        print("  - rep_financeiro_competencia")
